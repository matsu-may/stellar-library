...
contract `guess_the_number` via Soroban RPC.
...
soroban contract bindings ts \
  ...
  --contract-id CC5RIU667TL6XKYOP35RK6XWJK344LS5O2L6BXPXWPW2TKVB2NKN2T5G \
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url http://localhost:8000/rpc --network-passphrase \"Standalone Network ; February 2017\" --id CC5RIU667TL6XKYOP35RK6XWJK344LS5O2L6BXPXWPW2TKVB2NKN2T5G --name guess_the_number"
}
```
