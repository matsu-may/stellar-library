...
contract `library` via Soroban RPC.
...
soroban contract bindings ts \
  ...
  --contract-id CCKK5MUV26HJEOOX7LYW4IVW2XKWOCHUZ3M6OXNDDLWLQTEVYKHKMV65 \
...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url http://localhost:8000/rpc --network-passphrase \"Standalone Network ; February 2017\" --id CCKK5MUV26HJEOOX7LYW4IVW2XKWOCHUZ3M6OXNDDLWLQTEVYKHKMV65 --name library"
}
```
...
```js
import { Contract, networks } from "library"
